...
| `src/utils/image-watermark.ts` | `ACTIVE` | Pemampat WebP HD (<2MB) Sharp.js berserta overlay lencana cap *Racun Dapur Ibu*. |
...
| `apps/web/app/layout.tsx` | `ACTIVE` | Susun atur utama laman web berserta pembolehubah CSS tema *Warm Kitchen*. |
