...
export const themeConfig = {
  ...
  description: 'Warm kitchen theme inspired by delicate wildflowers and home cooking',
  ...
  components: {
    // 🟡 Button Variants
    button: {
      primary: `bg-gradient-to-r from-[${remberdawarColors.terracotta}] to-[${remberdawarColors.warmGold}] hover:from-[${remberdawarColors.s sage}] hover:to-[${remberdawarColors.terracotta}] shadow-medium transition-all duration-300`,
